...
| Main / Branch | Path | Role | Docs |
|---|---|---|---|
| **Main** | [`packages/core/`](./packages/core/) | **X-Agent framework** — `@x-agent/core` | [`packages/core/*.md`](./packages/core/README.md) |
| **Branch** | [`apps/agent-erp/`](./apps/agent-erp/) | **Agent_ERP** reference app (order → shipment PoC) | [`HANDOVER/`](./HANDOVER/README.md) |
